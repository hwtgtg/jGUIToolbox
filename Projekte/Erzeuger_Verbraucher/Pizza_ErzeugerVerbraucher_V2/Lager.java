...
public class Lager {
    ...
    public synchronized void ablegen(Kiste kiste) {
        ...
        //  Schon beim Erzeuger: zumLager(kiste);
        insLager(kiste);
    ...
    void zumVerbraucher(Kiste kiste, Verbraucher verbraucher) {
        int verbraucherX = verbraucher.posX - Kiste.breit;
        int verbraucherY = verbraucher.posY + Verbraucher.dy;

        int dx = (verbraucherX - kiste.posX) / 20;
        int dy = (verbraucherY - kiste.posY) / 20;
