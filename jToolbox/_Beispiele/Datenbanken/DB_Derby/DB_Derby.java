 ...
 * 
 * conOeffnen erzeugt eine Verbindung zu einer Datenbank.<br />
 * 
 ...
 * 
 * Benoetigt:
 * Sie erhalten die aktuelle Version der Datenbank von http://db.apache.org/derby/index.html .
 * (im Augenblick 10.7.1.1) <br />
 * Sie benoetigen mindestens die lib-Distribution. Den Ordner lib kopieren Sie zu Ihrem Projekt.
 * Die Datei derby.jar dem Build-Pfad hinzufuegen. <br />
 * 
 * <hr>
...
public class DB_Derby {
	...
	public boolean conOeffnen(String datenbank, String user, String kennwort) {
		...
		try {
			...
			String dbUrl = "jdbc:derby:"+datenbank+";create=true";
	...
	public boolean conClose() {
		...
		try {
			...
			System.out.println("Datenbankschliessen");
//			e.printStackTrace();
		}
