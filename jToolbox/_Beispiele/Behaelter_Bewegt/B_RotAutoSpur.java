...
public class B_RotAutoSpur implements ITuWas {
	...
	public B_RotAutoSpur(int neuesX, int neuesY) {
	...
	public void bewegen(){
		...
		autobehaelter.bewegen_LINEAR(600, 100);

		autobehaelter.bewegen_KREIS_Grad(100, 180, 100);
