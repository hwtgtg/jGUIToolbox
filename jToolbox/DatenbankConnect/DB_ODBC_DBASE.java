...
/**
 * <h1>Zugriff auf eine dbase-Datenbank ueber ODBC</h1><br />
 * -- <h1>Quelle - modifiziert:Zugriff auf eine Access-Datenbank</h1><br />
 * 
...
//ACCESS     String dbUrl = "jdbc:odbc:Driver={Microsoft Access Driver (*.mdb)};DBQ=" + datenbank;
            String dbUrl = "jdbc:odbc:Driver={Microsoft dBase Driver (*.dbf)};SourceType=DBF;DriverID=277;Exclusive=Yes;BackgroundFetch=Yes;Collate=Machine;Null=Yes;Deleted=Yes;DefaultDir=" + datenbank;
